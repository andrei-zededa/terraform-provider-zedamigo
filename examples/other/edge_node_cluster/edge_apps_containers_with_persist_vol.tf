...
resource "zedcloud_application" "CONTAINER_APP_DEF_WITH_VOL" {
  name  = "${var.DOCKERHUB_IMAGE_NAME}_container_app_vol_${var.config_suffix}"
  title = "${var.DOCKERHUB_IMAGE_NAME}_container_app_vol_${var.config_suffix}"
