...
resource "zedcloud_image" "ROOTFS_14_5_0_LTS" {
  #### This is wrong, the image name MUST be equal to the version. We do this because
  #### otherwise we likely will have a conflic with an existing image with the same
  #### version.
