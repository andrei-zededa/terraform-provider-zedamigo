# VM edge-app definition (Ubuntu 24.04 cloud image).
#
# NOTE: This file only creates the edge-app *definition*. No edge-app-instance
# and no network-instance are created here on purpose — deploy the app manually
# (e.g. attaching its interfaces to VLAN network-instances on eth1's trunk).
