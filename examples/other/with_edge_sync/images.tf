resource "zedcloud_image" "ubuntu_24_04_local_image" {
  name  = "ubuntu_24_04_local_image_${var.config_suffix}"
  title = "ubuntu_24_04_local_image_${var.config_suffix}"

  datastore_id = zedcloud_datastore.LOCAL_DATASTORE.id
...
resource "zedcloud_image" "ubuntu_24_04_server_cloud" {
  ...
  # So in this case, considering the `Local_HTTP_Server_8080` datastore it will be:
  #     http://192.168.192.168:8080/images_datastore/ubuntu_24_04_with_modbus_disk_999MB.qcow2
  image_rel_url    = "noble/20251213/noble-server-cloudimg-amd64.img"
  image_format     = "QCOW2"
  image_arch       = "AMD64"
  image_sha256     = "2B5F90FFE8180DEF601C021C874E55D8303E8BCBFC66FEE2B94414F43AC5EB1F"
  image_size_bytes = 626655744
  image_type       = "IMAGE_TYPE_APPLICATION"
}
